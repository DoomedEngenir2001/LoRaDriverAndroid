...
// в основном реализует пользовательский интерфейс
public class TerminalFragment extends Fragment implements ServiceConnection, SerialListener {
    ...
    public void onStart() {
        ...
        else getActivity().startService(new Intent(getActivity(), SerialService.class));// prevents service destroy on unbind from recreated activity caused by orientation change
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View chooseFilebtn = view.findViewById(R.id.sendFile);
        chooseFilebtn.setOnClickListener(v -> sendFile_());
        return view;
    }
    ...
    private void send(String str) {
        ...
        try {
            str = str + " " + " " + " " + " "; // fix to zipping message without this may uncorrect unzip
            String msg;
            byte[] data;
            if(hexEnabled) {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data){
        super.onActivityResult(requestCode, resultCode, data);
            ...
            assert uri_ != null;
            try{
                service.sendFlateFile(uri_);
            //    send(Rawdata);
            }catch(Exception e){
                Toast.makeText(service, e.toString(), Toast.LENGTH_SHORT).show();
            }
